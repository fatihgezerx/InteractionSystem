...
namespace InteractionSystem.Setup
{
    /// <summary>
    /// Keeps Interaction System from ever breaking a project that doesn't have its dependencies yet.
    /// </summary>
    /// <remarks>
    ...
    /// (e.g. <c>HAS_UNITASK</c>). Interaction System's own assemblies list those symbols as Define Constraints,
    /// so while a dependency is missing they are simply left out of compilation - no errors - and this
    /// guard offers to install what's missing. Once it is installed, the symbol is set and Interaction System
    ...
    internal sealed class DependencyGuard : AssetPostprocessor, IActiveBuildTargetChanged
    {
        ...
        private const string MenuPath = "Tools/Interaction System/Check Dependencies";
        private const string DontAskKey = "InteractionSystem.Setup.DontAskForDependencies";
        ...
        {
            new Dependency("Event System", "EventSystem.Runtime", "HAS_EVENT_SYSTEM", "https://github.com/fatihgezerx/EventSystem.git", "com.fatihgezer.eventsystem"),
            ...
            new Dependency("Input System", "Unity.InputSystem", "HAS_INPUT_SYSTEM", "com.unity.inputsystem", "com.unity.inputsystem"),
        };
    ...
    /// <summary>One package Interaction System uses.</summary>
