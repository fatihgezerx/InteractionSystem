...
{
    /// <summary>
    /// Adds Interaction System's UI to a project that uses UniMVC, without being asked: copies the view scripts
    /// shipped in this folder's <c>MVC</c> subfolder into the project's MVC folder - e.g. <c>MVC/Popups/</c>,
    /// <c>MVC/Texts/</c> - creating the subfolders if needed.
    /// </summary>
    /// <remarks>
    /// It happens on two occasions:
    /// <list type="bullet">
    /// <item>Interaction System was just imported: the hidden <c>MVC/.pending</c> marker that ships with it is still
    ...
    /// <item>UniMVC was just imported (or imported again) into a project that already has Interaction System.</item>
    /// </list>
    ...
    internal sealed class MvcIntegration : AssetPostprocessor
    {
        ...
        private const string SetupAssembly = "InteractionSystem.Setup";
